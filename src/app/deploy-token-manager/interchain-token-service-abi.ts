export const ITSAbi = [
  ...
  { inputs: [], name: 'AlreadyExpressCalled', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [], name: 'InvalidStringLength', type: 'error' },
  { inputs: [], name: 'InvalidTokenManagerImplementation', type: 'error' },
  ...
  { inputs: [], name: 'NotCanonicalTokenManager', type: 'error' },
  { inputs: [], name: 'NotOperator', type: 'error' },
  { inputs: [], name: 'NotOwner', type: 'error' },
  { inputs: [], name: 'NotProxy', type: 'error' },
  { inputs: [], name: 'NotRemoteService', type: 'error' },
  { inputs: [], name: 'NotTokenManager', type: 'error' },
  { inputs: [], name: 'Paused', type: 'error' },
  { inputs: [], name: 'SameDestinationAsCaller', type: 'error' },
  { inputs: [], name: 'SelectorUnknown', type: 'error' },
  { inputs: [], name: 'SetupFailed', type: 'error' },
  { inputs: [], name: 'StandardizedTokenDeploymentFailed', type: 'error' },
  { inputs: [], name: 'TokenManagerDeploymentFailed', type: 'error' },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bytes', name: 'operator', type: 'bytes' },
      {
        indexed: false,
        internalType: 'string',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: 'distributor', type: 'bytes' },
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: 'tokenId', type: 'bytes32' },
      { internalType: 'string', name: 'sourceChain', type: 'string' },
      { internalType: 'bytes', name: 'sourceAddress', type: 'bytes' },
      { internalType: 'address', name: 'destinationAddress', type: 'address' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'expressCaller', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'flowInAmount', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'tokenId', type: 'bytes32' }],
    name: 'getFlowLimit',
    outputs: [{ internalType: 'uint256', name: 'flowLimit', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'flowOutAmount', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenManagerType', type: 'uint256' },
    ],
    name: 'getImplementation',
    outputs: [
      { internalType: 'address', name: 'tokenManagerAddress', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [{ internalType: 'bytes', name: 'params', type: 'bytes' }],
    stateMutability: 'pure',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'operator',
    outputs: [{ internalType: 'address', name: 'operator_', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
